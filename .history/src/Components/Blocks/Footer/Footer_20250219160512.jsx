          ...
          <WidthBlock>
            <div className={classes.container}>
              ...
              <a href="tel:88005504017">8-800-550-40-17</a>
                ...
                <span>
                  <img src="/images/tg.png" onClick={() => window.location.href='https://alazarstudio.ru/'} />
                </span>
                <span>
                  <img src="/images/vk.png" onClick={() => window.location.href='https://alazarstudio.ru/'}/>
                </span>
                </div>
              </div>
              <div className={classes.container4}>
                
                <img src="/images/alazaR.webp" onClick={() => window.location.href='https://alazarstudio.ru/'} />
              </div>
            </div>
          </WidthBlock>
        </CenterBlock>
