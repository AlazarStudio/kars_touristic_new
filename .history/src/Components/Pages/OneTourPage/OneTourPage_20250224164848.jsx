...
import { multiDayTours, onerDayTours } from '../../../data/tours'; // Импорт данных
...
function OneTourPage({ tours = [...multiDayTours, ...onerDayTours] }) {
  ...
  if (!tour) {
    return <h2 className={classes.notFound}>Тур не найден</h2>;
  }
      ...
      <WidthBlock>
        <div className={classes.container}>
          ...
          <div className={classes.tourContent}>
            ...
            <span className={classes.price}>💰 Цена: {Number(tour.price).toLocaleString('ru-RU')} ₽</span>
