...
function Container1({
  ...
  // 🔹 Фильтрация только для туров (многодневные, однодневные, авторские)
            ...
            <div className={classes.cards}>
              {filteredData.length > 0 ? (
                filteredData.map((item) => (
                  selected === 3 ? <HotelCard item={item} key={item.id} />
                  : selected === 4 ? <PlacesCard item={item} key={item.id} />
                  : selected === 5 ? <EventsCard item={item} key={item.id} />
