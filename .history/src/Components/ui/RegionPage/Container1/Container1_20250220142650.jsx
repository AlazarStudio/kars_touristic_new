          ...
          <div className={classes.container}>
            ...
            <div className={classes.containerRight}>
              ...
              <div className={classes.containerRightEl}>
                ...
                <span>Однодневные экскурсии</span>
              </div>
              <div className={classes.containerRightEl}>
                <img src='/images/avtor.webp'/>
                <span>Авторские туры</span>
              </div>
              <div className={classes.containerRightEl}>
                <img src='/images/appart.webp'/>
                <span>Отели / Апартаменты</span>
              </div>
              <div className={classes.containerRightEl}>
                <img src='/images/searchLoc.webp'/>
                <span>Что посетить</span>
              </div>
              <div className={classes.containerRightEl}>
                <img src='/images/event.webp'/>
                <span>Региональные Mice ивенты</span>
              </div>
            </div>
          </div>
        </WidthBlock>
